...
const SPREADSHEET_CONTENT_POSTS = '1TF-JPBZ62Jqxe0Ilb_-GAe5xcOjQz-lE6NSFlrmNRvI';
...
const CONTENT_SQUAD_OWNER_ROLE_ID = '1290803054140199003';
const SQUAD_OWNER_ROLES = [SQUAD_LEADER_ROLE_ID, COMPETITIVE_SQUAD_OWNER_ROLE_ID, CONTENT_SQUAD_OWNER_ROLE_ID];
...
module.exports = {
    ...
    SPREADSHEET_CONTENT_POSTS,
    SPREADSHEET_LFO,
    SQUAD_LEADER_ROLE_ID,
    COMPETITIVE_SQUAD_OWNER_ROLE_ID,
    CONTENT_SQUAD_OWNER_ROLE_ID,
    SQUAD_OWNER_ROLES,
    BOOSTER_ROLE_ID,
    MODERATOR_ROLES,
    ITEMS_PER_PAGE,
