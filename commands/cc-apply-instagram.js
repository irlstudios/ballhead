...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            return interaction.editReply({content: 'Error checking Instagram account. Please try again later. Or try applying here : https://ballhead.app/applications/gym-class/content-creators/content-creator-application-login'});
        }
